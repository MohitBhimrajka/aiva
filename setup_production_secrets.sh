...
echo "sk_V2_hgu_k6NqK3GFzXO_siUVXeSVrCFc1st1KtzqiHehaxAA6W9c" | gcloud secrets create heygen-api-key --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_k6NqK3GFzXO_siUVXeSVrCFc1st1KtzqiHehaxAA6W9c" | gcloud secrets versions add heygen-api-key --data-file=-
print_success "Set heygen-api-key (primary)"

echo "sk_V2_hgu_kQ79IMRTMUS_0HnkGsiHiRM31WhmuVWQNZKDPzbwKxaG" | gcloud secrets create heygen-api-key-1 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_kQ79IMRTMUS_0HnkGsiHiRM31WhmuVWQNZKDPzbwKxaG" | gcloud secrets versions add heygen-api-key-1 --data-file=-
print_success "Set heygen-api-key-1"

echo "sk_V2_hgu_kjRkNRRrZzs_uNwQMoIzSkkvcp8V7Y16caO84OYZLwXr" | gcloud secrets create heygen-api-key-2 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_kjRkNRRrZzs_uNwQMoIzSkkvcp8V7Y16caO84OYZLwXr" | gcloud secrets versions add heygen-api-key-2 --data-file=-
print_success "Set heygen-api-key-2"

echo "sk_V2_hgu_kIyxdPXBh6A_tTA60Sn4hZ8jdOu9N66LLpUoa8aVKeru" | gcloud secrets create heygen-api-key-3 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_kIyxdPXBh6A_tTA60Sn4hZ8jdOu9N66LLpUoa8aVKeru" | gcloud secrets versions add heygen-api-key-3 --data-file=-
print_success "Set heygen-api-key-3"

echo "sk_V2_hgu_kkHbh03MKAa_PJqFZefWztYZ4vKMFFcs1yNlOkE2f0TM" | gcloud secrets create heygen-api-key-4 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_kkHbh03MKAa_PJqFZefWztYZ4vKMFFcs1yNlOkE2f0TM" | gcloud secrets versions add heygen-api-key-4 --data-file=-
print_success "Set heygen-api-key-4"

echo "sk_V2_hgu_ku0NEja2Nq6_8GzpjbjA2oL2iroA4D17N1LpOz3iydT9" | gcloud secrets create heygen-api-key-5 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_ku0NEja2Nq6_8GzpjbjA2oL2iroA4D17N1LpOz3iydT9" | gcloud secrets versions add heygen-api-key-5 --data-file=-
print_success "Set heygen-api-key-5"

echo "sk_V2_hgu_kSQctjowrV5_ntiMfEupOQuyz8ioJTWlCG1DinnrHdMx" | gcloud secrets create heygen-api-key-6 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_kSQctjowrV5_ntiMfEupOQuyz8ioJTWlCG1DinnrHdMx" | gcloud secrets versions add heygen-api-key-6 --data-file=-
print_success "Set heygen-api-key-6"

echo "sk_V2_hgu_kTefnYlCV6f_O2e6luZeK3jE1mAOIAD7So3B67f4ifsj" | gcloud secrets create heygen-api-key-7 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_kTefnYlCV6f_O2e6luZeK3jE1mAOIAD7So3B67f4ifsj" | gcloud secrets versions add heygen-api-key-7 --data-file=-
print_success "Set heygen-api-key-7"

echo "sk_V2_hgu_k3f9aSRNdUk_aEo20GwMpGI6xwtQfohrVPO8q0pR7aOk" | gcloud secrets create heygen-api-key-8 --data-file=- 2>/dev/null || \
echo "sk_V2_hgu_k3f9aSRNdUk_aEo20GwMpGI6xwtQfohrVPO8q0pR7aOk" | gcloud secrets versions add heygen-api-key-8 --data-file=-
